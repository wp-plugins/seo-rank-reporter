  ...
  <div style="<?php echo $displayNone; ?>" class="addFirstStep">  
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type="text" name="entry_url" id="entry_url" value="<?php  if (!empty($_POST['entry_url'])) { echo stripslashes(trim($_POST['entry_url'])); } else echo "http://"; ?>" class="kw_url_input regular-text" />
                <br />
              </td>
            </tr>
            </tbody>
