    ...
    <form action="" method="post">
      <table class="form-table">
        <tbody>
          ...
          <tr>
            <th><?php _e('Remove keywords and all ranking data', 'seo-rank-reporter'); ?></th>
      ...
      <div class="meta-box-sortables ui-sortable">
        <div id="toc" class="postbox" style="border:2px solid #009933;">
          ...
          <div class="inside">
            ...
            <p><?php _e('Are you a native speaker of another language?', 'seo-rank-reporter'); ?></p>
            <ul>
              <li><a href="http://www.kwista.com/contact-us/" target="_blank"><?php _e('Contact me about translating this plugin', 'seo-rank-reporter'); ?></a></li>
            </ul>
          </div>
        </div>
      </div>
