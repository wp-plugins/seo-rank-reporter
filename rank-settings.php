...
<h3>Email Notifications</h3>
        <form action="" method="post">
          <table class="form-table" style="padding:30px;background:#efefef;">
            <thead>
              <tr>
